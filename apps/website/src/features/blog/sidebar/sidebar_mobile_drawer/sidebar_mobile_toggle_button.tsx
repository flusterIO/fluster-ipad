...
export const MobileSidebarToggleButton = (): ReactNode => {
    return (
        <motion.button
            className={
                "fixed bottom-4 right-4 w-10 h-10 rounded-full flex items-center justify-center shadow-lg transition-transform z-100"
            }
            onClick={() => {
        ...
        >
            ...
            />
            <SearchIcon className="w-6 h-6 z-10 stroke-white/80" />
        </motion.button>
    );
};
