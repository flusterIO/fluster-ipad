...
![Fluster also supports hand-drawn sketches](/assets/images/mockups/ipad/mockups/paper.png)
...
![Fluster includes it's own set of embedded documentation](/assets/images/mockups/mac/mockups/mac_docs_example-front.png)
