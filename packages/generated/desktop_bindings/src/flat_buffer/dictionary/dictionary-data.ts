...
export class DictionaryData {
  ...
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):DictionaryData {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsDictionaryData(bb:flatbuffers.ByteBuffer, obj?:DictionaryData):DictionaryData {
  return (obj || new DictionaryData()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsDictionaryData(bb:flatbuffers.ByteBuffer, obj?:DictionaryData):DictionaryData {
...
static startDictionaryData(builder:flatbuffers.Builder) {
...
static endDictionaryData(builder:flatbuffers.Builder):flatbuffers.Offset {
  const offset = builder.endObject();
  builder.requiredField(offset, 4) // entries
  return offset;
}

static createDictionaryData(builder:flatbuffers.Builder, entriesOffset:flatbuffers.Offset):flatbuffers.Offset {
  DictionaryData.startDictionaryData(builder);
  DictionaryData.addEntries(builder, entriesOffset);
  return DictionaryData.endDictionaryData(builder);
}
}
