...
export class ParsedMdxDataTypescriptSafe {
    ...
    static getRootAsParsedMdxDataTypescriptSafe(
        bb: flatbuffers.ByteBuffer,
        obj?: ParsedMdxDataTypescriptSafe,
    ): ParsedMdxDataTypescriptSafe {
        return (obj || new ParsedMdxDataTypescriptSafe()).__init(
            bb.readInt32(bb.position()) + bb.position(),
            bb,
        );
    }

    static getSizePrefixedRootAsParsedMdxDataTypescriptSafe(
        bb: flatbuffers.ByteBuffer,
        obj?: ParsedMdxDataTypescriptSafe,
    ): ParsedMdxDataTypescriptSafe {
    ...
    tags(index: number, obj?: TagResultBuffer): TagResultBuffer | null {
        ...
        return offset
            ? (obj || new TagResultBuffer()).__init(
                this.bb!.__indirect(
    ...
    frontMatter(obj?: FrontMatterResultBuffer): FrontMatterResultBuffer | null {
        ...
        return offset
            ? (obj || new FrontMatterResultBuffer()).__init(
    ...
    citations(
        index: number,
        obj?: CitationResultBuffer,
    ): CitationResultBuffer | null {
        const offset = this.bb!.__offset(this.bb_pos, 10);
        return offset
            ? (obj || new CitationResultBuffer()).__init(
                this.bb!.__indirect(
                    this.bb!.__vector(this.bb_pos + offset) + index * 4,
                ),
                this.bb!,
    ...
    dictionaryEntries(
        index: number,
        obj?: DictionaryEntryResultBuffer,
    ): DictionaryEntryResultBuffer | null {
        const offset = this.bb!.__offset(this.bb_pos, 12);
        return offset
            ? (obj || new DictionaryEntryResultBuffer()).__init(
                this.bb!.__indirect(
                    this.bb!.__vector(this.bb_pos + offset) + index * 4,
                ),
                this.bb!,
    ...
    requiresSecondaryAiParse(
        index: number,
        obj?: SecondaryAiParseRequest,
    ): SecondaryAiParseRequest | null {
        const offset = this.bb!.__offset(this.bb_pos, 14);
        return offset
            ? (obj || new SecondaryAiParseRequest()).__init(
                this.bb!.__indirect(
                    this.bb!.__vector(this.bb_pos + offset) + index * 4,
                ),
                this.bb!,
    ...
    static addParsedContent(
        builder: flatbuffers.Builder,
        parsedContentOffset: flatbuffers.Offset,
    ) {
    ...
    static addFrontMatter(
        builder: flatbuffers.Builder,
        frontMatterOffset: flatbuffers.Offset,
    ) {
    ...
    static addCitations(
        builder: flatbuffers.Builder,
        citationsOffset: flatbuffers.Offset,
    ) {
    ...
    static addDictionaryEntries(
        builder: flatbuffers.Builder,
        dictionaryEntriesOffset: flatbuffers.Offset,
    ) {
        builder.addFieldOffset(4, dictionaryEntriesOffset, 0);
    }

    static createDictionaryEntriesVector(
        builder: flatbuffers.Builder,
        data: flatbuffers.Offset[],
    ): flatbuffers.Offset {
        builder.startVector(4, data.length, 4);
    ...
    static startDictionaryEntriesVector(
        builder: flatbuffers.Builder,
        numElems: number,
    ) {
        builder.startVector(4, numElems, 4);
    ...
    static addRequiresSecondaryAiParse(
        builder: flatbuffers.Builder,
        requiresSecondaryAiParseOffset: flatbuffers.Offset,
    ) {
        builder.addFieldOffset(5, requiresSecondaryAiParseOffset, 0);
    }

    static createRequiresSecondaryAiParseVector(
        builder: flatbuffers.Builder,
        data: flatbuffers.Offset[],
    ): flatbuffers.Offset {
        builder.startVector(4, data.length, 4);
    ...
    static startRequiresSecondaryAiParseVector(
        builder: flatbuffers.Builder,
        numElems: number,
    ) {
        builder.startVector(4, numElems, 4);
    ...
    static endParsedMdxDataTypescriptSafe(
        builder: flatbuffers.Builder,
    ): flatbuffers.Offset {
    ...
    static finishParsedMdxDataTypescriptSafeBuffer(
        builder: flatbuffers.Builder,
    ...
    static finishSizePrefixedParsedMdxDataTypescriptSafeBuffer(
        builder: flatbuffers.Builder,
        offset: flatbuffers.Offset,
    ) {
