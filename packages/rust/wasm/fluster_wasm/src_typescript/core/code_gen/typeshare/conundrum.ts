...
export type ParsedElement =
    ...
    | {
        tag: "ReactComponentSelfClosing";
        content: ReactComponentSelfClosingResult;
    }
    | {
        tag: "ReactComponentWithChildren";
        content: ReactComponentWithChildrenResult;
    }
...
export type MarkdownComponentOptionMap<T> = DashMap<
