use winnow::{Parser, combinator::separated, stream::Stream, token::take_till};

use crate::{
    lang::runtime::{state::conundrum_error_variant::ConundrumModalResult, traits::conundrum_input::ConundrumInput},
    parsers::{
        conundrum::logic::function::conundrum_function::ConundrumFunction,
        javascript::{
            function::javascript_function_parameter::javascript_function_parameter,
...
pub fn conundrum_named_function(input: &mut ConundrumInput) -> ConundrumModalResult<ConundrumFunction> {
    ...
    Ok(ConundrumFunction { parameters: function_arguments,
...
mod tests {
    ...
    const x = y / z;
        ...
        let res = conundrum_named_function.parse_next(&mut test_data)
