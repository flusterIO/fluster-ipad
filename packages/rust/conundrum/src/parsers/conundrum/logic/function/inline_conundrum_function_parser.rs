...
pub fn conundrum_inline_function(input: &mut ConundrumInput) -> ConundrumModalResult<ConundrumFunction> {
...
const x = 3 / 4;
        ...
        let res = conundrum_inline_function.parse_next(&mut test_data)
