...
/// ```askama
/// <div
/// class="{{tw_merge!("w-fit flex flex-col justify-center items-center gap-y-2 overflow-hidden", self.sizable.as_class(crate::lang::lib::ui::shared_props::sizable::SizablePropsOutputTarget::ImageParent)) | safe}}"
/// >
/// <img
