...
/// The same f--king thing as parse_elements, but without the wrapping paragraph
/// that catches everything.
pub fn parse_child_elements<'a>(input: &mut ConundrumInput<'a>) -> ConundrumModalResult<Vec<ParsedElement>> {
