...
> Customization will still be available via themeing and lower-level API's
...
This gives Conundrum a single core implementation across platforms, executable from a single Rust binary or any of the SDK's in active development.
...
Instead of an AI repeatedly reconstructing what it knows about an entity from an enormous collection of documents, the entity itself can accumulate relevant context.
