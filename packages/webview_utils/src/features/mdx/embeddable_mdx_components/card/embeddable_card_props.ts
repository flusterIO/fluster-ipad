...
export const embeddableCardPropsSchema = sizableObjectSchema.extend({
...
export type EmbeddableCardProps = z.infer<typeof embeddableCardPropsSchema>
export type EmbeddableCardPropsInput = z.input<typeof embeddableCardPropsSchema>
