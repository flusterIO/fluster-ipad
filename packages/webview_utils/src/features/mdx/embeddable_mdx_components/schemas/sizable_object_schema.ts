...
export const _sizableObjectSchema = {
    ...
    sidebar: z.boolean({ message: "'sidebar' is a boolean property." }).optional().transform((a) => a ? "w-full min-w-full @[768px]/mdx:w-1/3 @[768px]:min-w-[450px]" : "").describe('A utility property that sets a responsive max-width to create sidebar like layouts on large screens while allowing for full-width when the window is smaller.'),
