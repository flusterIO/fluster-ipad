import { getSizableObjectClasses, sizableObjectSchema } from "../../../mdx/embeddable_mdx_components/schemas/sizable_object_schema";
import { z } from "zod";
...
export type AINoteSummaryProps = z.input<typeof aiNoteSummaryProps>
