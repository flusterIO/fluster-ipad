...
export class NoteSearchResultSummary {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):NoteSearchResultSummary {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsNoteSearchResultSummary(bb:flatbuffers.ByteBuffer, obj?:NoteSearchResultSummary):NoteSearchResultSummary {
  return (obj || new NoteSearchResultSummary()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsNoteSearchResultSummary(bb:flatbuffers.ByteBuffer, obj?:NoteSearchResultSummary):NoteSearchResultSummary {
...
static startNoteSearchResultSummary(builder:flatbuffers.Builder) {
...
static endNoteSearchResultSummary(builder:flatbuffers.Builder):flatbuffers.Offset {
...
static createNoteSearchResultSummary(builder:flatbuffers.Builder, noteIdOffset:flatbuffers.Offset, titleOffset:flatbuffers.Offset, topicOffset:flatbuffers.Offset, subjectOffset:flatbuffers.Offset, tagsOffset:flatbuffers.Offset, lastModifiedStringOffset:flatbuffers.Offset, lastReadStringOffset:flatbuffers.Offset):flatbuffers.Offset {
  NoteSearchResultSummary.startNoteSearchResultSummary(builder);
  NoteSearchResultSummary.addNoteId(builder, noteIdOffset);
  NoteSearchResultSummary.addTitle(builder, titleOffset);
  NoteSearchResultSummary.addTopic(builder, topicOffset);
  NoteSearchResultSummary.addSubject(builder, subjectOffset);
  NoteSearchResultSummary.addTags(builder, tagsOffset);
  NoteSearchResultSummary.addLastModifiedString(builder, lastModifiedStringOffset);
  NoteSearchResultSummary.addLastReadString(builder, lastReadStringOffset);
  return NoteSearchResultSummary.endNoteSearchResultSummary(builder);
}
}
