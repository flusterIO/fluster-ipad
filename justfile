...
pre_ipad_build: copy_mathjax_to_public_dir generate_initial_launch_data write_zod_schema_docs build_cross_language_all build_conundrum_swift build_fluster_bibliography generate_initial_note_paths build_splitview_mdx_editor_ipad build_bibtex_editor_webview_ipad build_note_detail_webview_ipad build_dictionary_webview_ipad

generate_shiki_themes:
	tsx scripts/write_bundled_themes.ts

pre_desktop_build: copy_mathjax_to_public_dir generate_shiki_themes write_zod_schema_docs generate_initial_launch_data build_cross_language_all build_fluster_bibliography generate_initial_note_paths build_fluster_core_rust_utilities build_desktop_fs build_conundrum_swift build_webview_utils build_splitview_mdx_editor_mac build_standalone_mdx_preview_webview_mac build_bibtex_editor_webview_mac build_dictionary_webview_mac build_note_detail_webview_mac
